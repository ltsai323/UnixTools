...
storeFileName='store_root/keepMCevent_3rdStep_LbTkShape_sysmaticErrFit_noKinematicCut_{0}.root'.format(ptRange)
storeFigName ='store_fig/pdf_keepMCevent_3rdStep_LbTkShape_sysmaticErrFit_noKinematicCut_{0}.pdf'.format(ptRange)
storeTXTName='log_keepMCevent_3rdStep_LbTkShape_sysmaticErrFit_noKinematicCut_{0}.txt'.format(ptRange)
...
workspaceFileE=TFile.Open('store_root/keepMCevent_shortRangeLbFit_noKinematicCut.{0}.root'.format(ptRange))
