...
outFileName='store_root/keepMCevent_0thStep_LbL0Shape_noKinematicCut.{0}.root'.format(ptRange)
outFig='store_fig/pdf_keepMCevent_0thStep_LbL0Shape_noKinematicCut.{0}.pdf'.format(ptRange)
...
inFF=TFile.Open('store_root/keepMCevent_LbL0NflatNtuple_noSelection.root')
