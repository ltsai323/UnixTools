...
outFileName='store_root/keepMCevent_1stStep_MCShape.root'
dataFileName='store_root/result_flatNtuple_LbTk_preSelection_noKinematicCut.root'
storeFileName='store_root/keepMCevent_shortRangeLbFit_noKinematicCut.{0}.root'.format(ptRange)
storeFigName='store_fig/pdf_keepMCevent_shortRangeLbFit_noKinematicCut.{0}.pdf'.format(ptRange)
...
if load2016Data:
    ...
    if LbModelBuilding:
        ...
        if buildBKGModel:
            ...
            space.factory('cp1[0.3,-2.,2.]')
            space.factory('cp2[-0.7,-3.,3.]')
            space.factory('cp3[-0.07,-2.,2.]')
    ...
    if lBModelBuilding:
        ...
        if buildBKGModel:
            ...
            space.factory('cp1_[0.3,-2.,2.]')
            space.factory('cp2_[-0.7,-3.,3.]')
            space.factory('cp3_[-0.07,-2.,2.]')
...
print 'mv {0} {1}'.format(tMPrOOTnAME,storeFileName)
